...
class ModelMapper {
    ...
    buildMoment(value) {
        return value ? (moment_1.default.isMoment(value) ? value : moment_1.default(value)) : undefined;
    }
    buildMomentDuration(value) {
        return value ? (moment_1.default.isDuration(value) ? value : moment_1.default.duration(value)) : undefined;
    }
}
